...
export function LandingPage() {
  const [clientsData, setClientsData] = useState([
    {
      imgUrl: "/icons/Ellipse 29.svg",
      name: "Rowhan Smith",
      designation: "CEO, Foreclosure",
      description:
        "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Alias veritatis, quae vitae tenetur excepturi quo iure possimus adipisci a architecto neque eveniet eius, sed itaque iusto maxime libero porro nam?",
    },
    {
      imgUrl: "/icons/Ellipse 29.svg",
      name: "Rowhan Smith",
  ...
  const [propertyData, setProperyData] = useState([
    {
      name: "Project Name",
      description: "Consultation",
      location: "Rajendra Nagar",
      imgUrl: "/icons/pexels-brett-sayles-2881232.svg",
    },
    {
      name: "Project Name",
      description: "Design",
              ...
              <div className="w-full h-full flex items-center mt-5 justify-center gap-5 px-20">
                ...
                <div className="flex flex-col items-center text-center">
                  <div className="relative">
                    <img src="/shapes/Ellipse 10.svg" />
                    <div className="absolute top-1/4 right-1/4">
                      <img src="images/paintbrush-2.svg" />
                    </div>
                  </div>
                  <div className="text-sky-700 text-2xl font-bold mt-5">
                    Design
